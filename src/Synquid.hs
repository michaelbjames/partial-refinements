...
synt = Synthesis {
  ...
  Main.intersection   = GuardedPowerset    &= help (unwords ["What technique should be used to infer type of symbols?", show GuardedPowerset, show EitherOr, show LaurentBCD, "(default: " ++ show GuardedPowerset ++ ")"]),
